                      ...
                      <table class="table table-responsive-sm">
                        <tbody>
                          ...
                          <tr style="background: white;">
                            ...
                            <td
                              class="font-weight-bold pt-2"
                              v-text="cuantitativa.ratios_endeudamiento_resultado"
                            ></td>
                          </tr>
                          <tr style="background: white;">
                      ...
                      <table class="table table-responsive-sm">
                        <tbody>
                          ...
                          <tr style="background: white;">
                            ...
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_activo_caja"
                            ></td>
                            <td class="pt-2">DEUDAS</td>
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_pasivo_deudas"
                            ></td>
                          </tr>
                          <tr style="background: white;">
                            ...
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_activo_inventario"
                            >0</td>
                          ...
                          <tr style="background: white;">
                            ...
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_activo_f"
                            ></td>
                            <td class="pt-2">CAPITAL</td>
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_patrimonio_capital"
                            ></td>
                          </tr>
                          ...
                          <tr style="background: white;">
                            ...
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_patrimonio_utilidad"
                            ></td>
                          </tr>
                          ...
                          <tr style="background: white;">
                            ...
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_activo_total"
                            ></td>
                            <td class="pt-2">TOTAL</td>
                            <td
                              class="font-weight-bold pt-2"
                              v-text="'S/. '+cuantitativa.balance_patrimonio_total"
                            ></td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <table id="travel" style="width: 100%;">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td colspan="4">
                          <span v-text="cuantitativa.resultado_eva"></span>
                        </td>
                      </tr>
                      <tr>
                        <th scope="row">RESULTADO SIST</th>
                        <td colspan="4">
                          <span v-text="cuantitativa.resultado_sist"></span>
                        </td>
                      </tr>
                    </tfoot>
                    ...
                    <tbody>
                      <tr class>
                        ...
                        <td v-text="'S/. '+cuantitativa.ingresos_ventas_titular"></td>
                        <td v-text="'S/. '+cuantitativa.ingresos_ventas_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.ingresos_ventas_total"></td>
                        <td v-text="'S/. '+cuantitativa.ingresos_ventas_validacion"></td>
                      </tr>

                      <tr class>
                        <th scope="row">Costo de venta</th>
                        <td v-text="'S/. '+cuantitativa.costo_venta_titular"></td>
                        <td v-text="'S/. '+cuantitativa.costo_venta_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.costo_venta_total"></td>
                        <td v-text="'S/. '+cuantitativa.costo_venta_validacion"></td>
                      </tr>

                      <tr class>
                        <th scope="row">Margen Bruto</th>
                        <td v-text="'S/. '+cuantitativa.margen_bruto_titular"></td>
                        <td v-text="'S/. '+cuantitativa.margen_bruto_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.margen_bruto_total"></td>
                        <td v-text="'S/. '+cuantitativa.margen_bruto_validacion"></td>
                      </tr>

                      <tr class>
                        <th scope="row">Servicios LAT</th>
                        <td v-text="'S/. '+cuantitativa.servicios_lat_titular"></td>
                        <td v-text="'S/. '+cuantitativa.servicios_lat_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.servicios_lat_total"></td>
                        <td v-text="'S/. '+cuantitativa.servicios_lat_validacion"></td>
                      </tr>

                      <tr class>
                        <th scope="row">Alquiler</th>
                        <td v-text="'S/. '+cuantitativa.alquiler_titular"></td>
                        <td v-text="'S/. '+cuantitativa.alquiler_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.alquiler_total"></td>
                        <td v-text="'S/. '+cuantitativa.alquiler_validacion"></td>
                      </tr>

                      <tr class>
                        <th scope="row">Empleados</th>
                        <td v-text="'S/. '+cuantitativa.empleados_titular"></td>
                        <td v-text="'S/. '+cuantitativa.empleados_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.empleados_total"></td>
                        <td v-text="'S/. '+cuantitativa.empleados_validacion"></td>
                      </tr>

                      <tr class>
                        <th scope="row">Gasto Financiero</th>
                        <td v-text="'S/. '+cuantitativa.gasto_financiero_titular"></td>
                        <td v-text="'S/. '+cuantitativa.gasto_financiero_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.gasto_financiero_total"></td>
                        <td v-text="'S/. '+cuantitativa.gasto_financiero_validacion"></td>
                      </tr>
                      <tr class>
                        <th scope="row">Utilidad neta neogico</th>
                        <td v-text="'S/. '+cuantitativa.utilidad_neta_negocio_titular"></td>
                        <td v-text="'S/. '+cuantitativa.utilidad_neta_negocio_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.utilidad_neta_negocio_total"></td>
                        <td v-text="'S/. '+cuantitativa.utilidad_neta_negocio_validacion"></td>
                      </tr>
                      <tr class>
                        <th scope="row">Otros ingresos</th>
                        <td v-text="'S/. '+cuantitativa.otros_ingresos_titular"></td>
                        <td v-text="'S/. '+cuantitativa.otros_ingresos_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.otros_ingresos_total"></td>
                        <td v-text="'S/. '+cuantitativa.otros_ingresos_validacion"></td>
                      </tr>
                      <tr class>
                        <th scope="row">Gasto Hogar</th>
                        <td v-text="'S/. '+cuantitativa.gasto_hogar_titular"></td>
                        <td v-text="'S/. '+cuantitativa.gasto_hogar_conyuge"></td>
                        <td v-text="'S/. '+cuantitativa.gasto_hogar_total"></td>
                        <td v-text="'S/. '+cuantitativa.gasto_hogar_validacion"></td>
                      </tr>
                      <tr class>
                        <th scope="row">Gasto Financiero Personal</th>
                        <td v-text="'s/. '+cuantitativa.gasto_financiero_personal_titular"></td>
                        <td v-text="'s/. '+cuantitativa.gasto_financiero_personal_conyuge"></td>
                        <td v-text="'s/. '+cuantitativa.gasto_financiero_personal_total"></td>
                        <td v-text="'s/. '+cuantitativa.gasto_financiero_personal_validacion"></td>
                      </tr>
                      <tr class>
                        <th scope="row">Disponible</th>
                        <td v-text="'s/. '+cuantitativa.disponible_titular"></td>
                        <td v-text="'s/. '+cuantitativa.disponible_conyuge"></td>
                        <td v-text="'s/. '+cuantitativa.disponible_total"></td>
                        <td v-text="'s/. '+cuantitativa.disponible_validacion"></td>
                      </tr>
                      <tr class>
                        <th scope="row">Cuota insitución</th>
                        <td v-text="'s/. '+cuantitativa.cuota_institucion_titular"></td>
                        <td v-text="'s/. '+cuantitativa.cuota_institucion_conyuge"></td>
                        <td v-text="'s/. '+cuantitativa.cuota_institucion_total"></td>
                        <td v-text="'s/. '+cuantitativa.cuota_institucion_validacion"></td>
                      </tr>
                      <tr class>
                        <th scope="row">Disponible desp. Cuota</th>
                        <td v-text="'s/. '+cuantitativa.utilidad_desp_cuota_titular"></td>
                        <td v-text="'s/. '+cuantitativa.utilidad_desp_cuota_conyuge"></td>
                        <td v-text="'s/. '+cuantitativa.utilidad_desp_cuota_total"></td>
                        <td v-text="'s/. '+cuantitativa.utilidad_desp_cuota_validacion"></td>
                      </tr>
                      <tr class>
      ...
      <div class="evaluation_wrapper">
        <div class="input_box">
          <div class="input_box_wrapper">
            ...
            <div class="input_checkbox_wrapper radio" v-if="currentUserNivel=='3'">
              <input
                type="radio"
                id="radio2"
                name="evaluation"
            ...
            <div class="input_checkbox_wrapper radio">
              ...
              <label class="box_content" for="radio3">
                <div class="box"></div>
                <span>{{currentUserNivel== '3' ? 'Desaprobado' : 'Rechazado'}}</span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="form_content">
          <div class="input_wrapper" v-if="currentUserNivel=='3'">
...
export default {
  ...
  mounted() {
    this.currentUserNivel = this.$store.state.currentUser.nivel
  ...
  methods: {
    ...
    formInit() {
      ...
      } else if (this.currentUserNivel == "3") {
        this.form = {
          detalle: "",
          estado: "",
          prestamos_id: ""
