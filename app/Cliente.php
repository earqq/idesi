...
class Cliente extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['tipo_documento', 'documento', 'codigo', 'tipo_cliente', 'numero_registro', 'agencia', 'pais', 'departamento', 'provincia', 'distrito', 'estado', 'deleted_at', 'created_at', 'updated_at'];
