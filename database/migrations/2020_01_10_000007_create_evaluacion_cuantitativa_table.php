...
class CreateEvaluacionCuantitativaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->decimal('gasto_financiero_personal_titular')->nullable();
            $table->decimal('gasto_financiero_personal_conyuge')->nullable();
            $table->decimal('gasto_financiero_personal_total')->nullable();
            $table->decimal('gasto_financiero_personal_validacion')->nullable();
            $table->decimal('fc_diario_minimo_ingreso')->nullable();
            $table->decimal('fc_diario_cuota')->nullable();
            $table->decimal('fc_diario_disponible_diario')->nullable();
            $table->decimal('fc_diario_participacion_cuota')->nullable();
            $table->string('fc_diario_resultado', 100)->nullable();
            $table->decimal('fc_semanal_minimo_ingreso')->nullable();
            $table->decimal('fc_semanal_cuota')->nullable();
            $table->decimal('fc_semanal_participacion_cuota')->nullable();
            $table->string('fc_semanal_resultado', 100)->nullable();
            $table->decimal('fc_semanal_disponible_semana')->nullable();
        });
    }
