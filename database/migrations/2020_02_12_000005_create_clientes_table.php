...
class CreateClientesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->integer('ubicacion_interior')->nullable();
            $table->string('ubicacion_manzana', 5)->nullable();
            $table->integer('ubicacion_lote')->nullable();
            $table->integer('ubicacion_piso')->nullable();
            $table->integer('ubicacion_numero')->nullable();
            $table->integer('ubicacion_nro_departamento')->nullable();
